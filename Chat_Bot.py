...
def weather(city):
    ...
    api_key = "de4be1c6c6fdb5c399c484d8dfee8e25"
...
def run_bot():
    ...
    if 'play' in command :
        ...
        engine_talk(pyjokes.get_joke(language="en", category="all"))
        ...
        pykit.sendwhatmsg("+91(xxxxxxxxx)","Msg",00,42)
        engine_talk('Message sended')
    elif 'stop' in command:
        engine_talk('Thanks From Saurabhs Bot')
        sys.exit()
    else:
